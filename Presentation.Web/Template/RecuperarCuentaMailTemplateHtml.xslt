                          ...
                          <div class="editable-text" style="line-height: 2;">
                            <span class="text_container">
                              <multiline>
                                ...
                                Hemos recibido una solicitud para restablecimiento de su contraseña, si no está seguro de haber solicitado esta acción, por favor haga caso omiso, de lo contrario haga clic en el siguiente enlace:
                              </multiline>
                            </span>
                          </div>
                        </td>
                            ...
                            <tr>
                              <td  align="center" valign="middle" style="color: #ffffff; font-size: 16px; font-weight: 600; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;"
                                ...
                                <div class="editable-text">
                                  <span class="text_container">
                                    <multiline>
                                      <a href="{//@url_recuperar_cuenta}" style="text-decoration: none; color: #ffffff;">Restablecer contraseña</a>
                                    </multiline>
                                  </span>
                                </div>
                              </td>
