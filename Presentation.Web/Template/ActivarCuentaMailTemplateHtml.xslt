                              ...
                              <td  align="center" class="text_color_282828" style="color: #282828; font-size: 15px; font-weight: 700; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
                                <div class="editable-text">
                                  <span class="text_container">
                                    <multiline>
                                      Estimado(a) "
                                      <xsl:value-of select="//@name" />", muchas gracias por registrarse en:
                                    </multiline>
                                  </span>
                                </div>
                              </td>
                ...
                <tr>
                  <td>
                    ...
                    <table class="table1" width="520" align="center" border="0" cellspacing="0" cellpadding="0" style="margin: 0 auto;">
                      ...
                      <tr>
                        <td  align="left" class="center_content text_color_a1a2a5" style="color: #a1a2a5; font-size: 14px;line-height: 2; font-weight: 500; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
                          <div class="editable-text" style="line-height: 2;">
                            <span class="text_container">
                              <multiline>
                                Para terminar el proceso de creación de su cuenta ingrese con su usuario:
                              </multiline>
                            </span>
                          </div>
                        </td>
                      ...
                      <tr>
                        <td  align="left" class="center_content text_color_282828" style="color: #282828; font-size: 15px; font-weight: 700; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
                          <div class="editable-text">
                            <span class="text_container">
                              <multiline>
                            ...
                            <tr>
                              <td  align="center" valign="middle" style="color: #ffffff; font-size: 16px; font-weight: 600; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;"
                                ...
                                <div class="editable-text">
                                  <span class="text_container">
                                    <multiline>
                                      <a href="{//@url_activar_cuenta}" style="text-decoration: none; color: #ffffff;">Ingresar</a>
                                    </multiline>
                                  </span>
                                </div>
                              </td>
                      ...
                      <tr>
                        <td  align="left" class="center_content text_color_a1a2a5" style="color: #a1a2a5; font-size: 14px;line-height: 2; font-weight: 500; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
                          <div class="editable-text" style="line-height: 2;">
                            <span class="text_container">
                              <multiline>
                                Asigne una contraseña, recuerde que debe ingresar como mínimo 8 caracteres, que contenga una mayúscula, una minúscula y un
                                digito numérico.
                              </multiline>
                            </span>
                          </div>
