    ...
    <html>
      <head>
        <style>
          ...
          .DraftLaws,.DraftLaws th,.DraftLaws td {
                    ...
                    <table class="table1" width="520" align="center" border="0" cellspacing="0" cellpadding="0" style="margin: 0 auto;">
                      ...
                      <tr>
                        ...
                        <td style="text-align: center;">
                          ...
                          <table class="DraftLaws">
                            <tr>
                              <th>Nro. proyecto de ley</th>
                              <th>Título</th>
                              <th>Estado</th>
                            ...
                            <xsl:for-each select="NotificationDraftLawViewModel/DraftLaws/DraftLawViewModel">
                              <tr>
                                <td>
                                ...
                                <td>
                                  <xsl:value-of select="@interest_area"/>
                                </td>
                                <td>
                            ...
                            <tr>
                              <td  align="center" valign="middle" style="color: #ffffff; font-size: 16px; font-weight: 600; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;"
                                ...
                                <div class="editable-text">
                                  <span class="text_container">
                                    <multiline>
                                      <a href="{//@url}" style="text-decoration: none; color: #ffffff;">Ingresar</a>
                                    </multiline>
                                  </span>
                                </div>
                              </td>
