    ...
    <html>
      <head>
        <style>
          ...
          .TableWithOutBorder,.TableWithOutBorder th,.TableWithOutBorder td {
          border: 0px;
          }
        </style>
      </head>
                      ...
                      <tr>
                        <td  align="left" class="center_content text_color_a1a2a5" style="color: #a1a2a5; font-size: 14px;line-height: 2; font-weight: 500; font-family: lato, Helvetica, sans-serif; mso-line-height-rule: exactly;">
                          <div class="editable-text" style="line-height: 2;">
                            <span class="text_container">
                              <multiline>
                                De acuerdo a su solicitud se muestra a continuación los datos de contacto del investigador del concepto técnico con número "<xsl:value-of select="//@concept_id" />":
                              </multiline>
                            </span>
                          </div>
                        </td>
                      ...
                      <tr>
                        <td align="center">
                          ...
                          <table class="TableWithOutBorder">
                            <tr>
                              <td>
                                <b>Nombre de investigador:</b>
                              </td>
                              <td>
                                <xsl:value-of select="//@contact_data_name" />
                              </td>
                            ...
                            <tr>
                              ...
                              <td>
                                <xsl:value-of select="//@contact_data_phone" />
                              </td>
                            ...
                            <tr>
                              ...
                              <td>
                                <xsl:value-of select="//@contact_data_email" />
                              </td>
