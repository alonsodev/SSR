...
seq = 0, delays = 80, durations = 500, seq2 = 0, delays2 = 80, durations2 = 500, isWindows = -1 < navigator.platform.indexOf("Win"), isWindows ? ($(".sidebar .sidebar-wrapper, .main-panel").perfectScrollbar(), $("html").addClass("perfect-scrollbar-on")) : $("html").addClass("perfect-scrollbar-off"), $(document).ready(function () {
    $navbar = $(".navbar[color-on-scroll]"), scroll_distance = $navbar.attr("color-on-scroll") || 500, $('[data-toggle="tooltip"], [rel="tooltip"]').tooltip(), $('[data-toggle="popover"]').each(function () {
    ...
    0 != $(".tagsinput").length && $(".tagsinput").tagsinput(), $(".bootstrap-tagsinput").addClass(a + "-badge"), 0 != $(".selectpicker").length && $(".selectpicker").selectpicker({
        ...
        tickIcon: "ui-1_check"
    }), $("body").hasClass("sidebar-mini") && (sidebar_mini_active = !0), navigator.platform.startsWith("Win") && $(".modal").on("shown.bs.modal", function () {
        ...
        $(document).scrollTop() <= scroll_distance && $(this).closest(".navbar").addClass("navbar-transparent").removeClass("bg-white")
    }), $(".form-file-simple .inputFileVisible").click(function () {
        $(this).siblings(".inputFileHidden").trigger("click")
    }), $(".form-file-simple .inputFileHidden").change(function () {
        var a = $(this).val().replace(/C:\\fakepath\\/i, "");
        $(this).siblings(".inputFileVisible").val(a)
    }), $(".form-file-simple .inputFileHidden, .form-file-multiple .inputFileHidden").css("z-index", "-1"), $(".form-file-multiple .inputFileVisible, .form-file-multiple .input-group-btn").click(function () {
        $(this).siblings(".inputFileHidden").trigger("click")
